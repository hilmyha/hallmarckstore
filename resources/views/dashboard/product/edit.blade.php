<x-dashboard-layout title="Edit">
  <div class="container grid gap-4 md:gap-6">
    <x-dashboard-form>
      ...
      <x-slot name="action">/dashboard/products/{{ $products->id }}</x-slot>
      ...
      <x-partials.input name="input">
        ...
        <x-slot name="old">{{ old('name', $products->name) }}</x-slot>
      </x-partials.input>
      ...
      <x-partials.input name="input">
        ...
        <x-slot name="old">{{ old('slug', $products->slug) }}</x-slot>
      </x-partials.input>
      ...
      <x-partials.input name="input">
        ...
        <x-slot name="old">{{ old('price', $products->price) }}</x-slot>
      </x-partials.input>
      ...
      <x-partials.input name="input">
        ...
        <x-slot name="old">{{ old('description', $products->description) }}</x-slot>
      </x-partials.input>
